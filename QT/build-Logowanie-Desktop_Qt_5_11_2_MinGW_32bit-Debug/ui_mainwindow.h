...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setGeometry(QRect(0, 50, 621, 241));
        ...
        label_zdjecie = new QLabel(groupBox);
        label_zdjecie->setObjectName(QStringLiteral("label_zdjecie"));
        label_zdjecie->setGeometry(QRect(400, 40, 171, 171));
        widget = new QWidget(groupBox);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 50, 361, 101));
